...
function Sidebar() {
  ...
  const  AddNewChat =()=>{
    ...
    audio.play();   
    toast.success('Channel Successfully Created',{position:toast.POSITION.TOP_CENTER})   
    }
 }
    ...
    <div className="side-bar">
        ...
        <div className="sidebar-search">
          <div className="search-container">
            <SearchIcon/>
            <input onChange={filterChannels} type="text" placeholder="Search or Start a new Chat"/>
          </div>   
        </div>
